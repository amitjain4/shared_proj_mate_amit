...
for vn = 0.04:0.04:0.2
    ...
    for i=1:Q
        vn0 = abs(coeff(Q+i+1));
        [Transfer_ff,x] = EvalTF(freq(i+1),vn0,Y,Ron_p,Cds_p,Cgd2,Cgs3,Cds2,Cds3,Ron3,ro2,Cgd3,Cgs2,gm2,C1,C2,Ccm);
...
subplot(3,1,1);
plot(vinpk,outa(1:5),strcat('red','-x'))
...
%Matrices
subplot(3,1,3)
plot(vinpk,outb(1:5),strcat('blue','-o'))
...
function [Transfer_fresult,x] = EvalTF(freq,vnx,Y,Ron_p,Cds_p,Cgd2,Cgs3,Cds2,Cds3,Ron3,ro2,Cgd3,Cgs2,gm2,C1,C2,Ccm)
